...
var Layout = function () {
    ...
    var resBreakpointMd = Custom.getResponsiveBreakpoint('md');
    ...
    var handleMainMenu = function () {
        ...
        $(".page-header .menu-toggler").on("click", function(event) {
            if (Custom.getViewPort().width < resBreakpointMd) {
    ...
    var handleMainMenuOnResize = function() {
        // handle hover dropdown menu for desktop devices only
        var width = Custom.getViewPort().width;
    ...
    var handleContentHeight = function() {
        ...
        if ($('body').height() < Custom.getViewPort().height) {            
            height = Custom.getViewPort().height -
    ...
    return {
        ...
        initHeader: function() {
            ...
            Custom.addResizeHandler(handleMainMenuOnResize); // handle main menu on window resize

            if (Custom.isAngularJsApp()) {      
        ...
        closeMainMenu: function() {
            ...
            if (Custom.getViewPort().width < resBreakpointMd && $('.page-header-menu').is(":visible")) { // close the menu on mobile view while laoding a page 
                $('.page-header .menu-toggler').click();
            }
        },

        getLayoutImgPath: function() {
            return Custom.getAssetsPath() + layoutImgPath;
        },

        getLayoutCssPath: function() {
            return Custom.getAssetsPath() + layoutCssPath;
        }
    };
