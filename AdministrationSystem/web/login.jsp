<%-- 
    Document   : admin
    Created on : Aug 25, 2015, 8:18:13 PM
    Author     : GOHENGCHI
--%>
      ...
      <div class="page-login-main">
        ...
        <form method="post" action="home.jsp">
          ...
          <h3 class="font-size-20">Employee Sign In</h3>
            ...
            <input type="email" class="form-control" id="inputEmail" name="email" placeholder="Employee Email">
          </div>
          <div class="form-group">
          ...
          <div class="form-group clearfix">
            ...
            <a class="pull-right" href="forgot.jsp">Forgot password?</a>
          </div>
